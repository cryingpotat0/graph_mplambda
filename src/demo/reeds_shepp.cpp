...
namespace mpl::demo
{
    ...
    const double pi = 3.14159265358979323846264338327950288419716939937510582097494459230781640628620L;
    ...
    double ReedsSheppStateSpace::distance(double q0[3], double q1[3]) const
    {
      return rho_ * reedsShepp(q0, q1).length();
    }

    ReedsSheppStateSpace::ReedsSheppPath ReedsSheppStateSpace::reedsShepp(double q0[3], double q1[3]) const
    {
      double dx = q1[0] - q0[0], dy = q1[1] - q0[1], dth = q1[2] - q0[2];
      double c = cos(q0[2]), s = sin(q0[2]);
      double x = c*dx + s*dy, y = -s*dx + c*dy;
      return mpl::demo::reedsShepp(x/rho_, y/rho_, dth);
    }

    void ReedsSheppStateSpace::type(double q0[3], double q1[3], ReedsSheppPathTypeCallback cb, void* user_data) const
    {
    ...
    */
    ...
    void ReedsSheppStateSpace::interpolate(double q0[3], ReedsSheppPath &path, double seg, double s[3]) const
    {
